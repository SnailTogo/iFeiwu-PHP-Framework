 ...
 class Page{
		...
		**/
		function pre_page($style = '') {
			if($this->nowindex > 1) {
				return $this->_get_link($this->_get_url($this->nowindex-1), $this->pre_page, 'pre');  // $style
			}
			
			return '<li class="'.$style.'"><a href="#">'.$this->pre_page.'</a></li>';
		}
		...
		**/
		function next_page($style = '') {
			if($this->nowindex < $this->totalpage) {
				return $this->_get_link($this->_get_url($this->nowindex+1), $this->next_page, 'next');// $style
			}
			
			return '<li class="'.$style.'"><a href="#">'.$this->next_page.'</a></li>';
		}
		...
		**/
		...
		function first_page($style = '') {
			if($this->first_page == 1) {
				return '<li class="'.$style.'"><a href="#">'.$this->first_page.'</a></li>';
			}
		...
		**/
		function last_page($style = '') {
			if($this->last_page == $this->totalpage) {
				return '<li class="'.$style.'"><a href="#">'.$this->total.'</a></li>';	
			}
			...
			for($i = $begin; $i < $begin + $this->pagebarnum; $i++) {
				 if($i <= $this->totalpage) {
				 		if($i != $this->nowindex) 
				 		  ...
				 		  $return .= $this->_get_text('<li class="'.$nowindex_style.'"><a href="#">'.$i.'</a></li>');
				 } else {
				 		break;
				 }
				 $return .= " ";/* \n */
...
// 				  $this->pre_page = '上一页';
// 				  $this->next_page = '下一页';
				  return $this->pre_page('disabled').$this->nowbar('', 'active').$this->next_page('disabled');
				  break;
    			...
    			case '6':
			      return $this->nowbar('', 'active');
			      break;
			      
		        case '7':
		          return $this->pre_page('disabled').$this->next_page('disabled');
		          break;
			}
		}
